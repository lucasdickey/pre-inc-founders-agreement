...
exports.VALIDATION_CHECKLIST = exports.COFOUNDER_QUESTIONS = exports.INTERVIEW_SECTIONS = exports.EXIT_TERMS = exports.VESTING_TERMS = void 0;
exports.validateSection = validateSection;
exports.validateAllSections = validateAllSections;
// Term explanations from skill.md
exports.VESTING_TERMS = [
...
exports.INTERVIEW_SECTIONS = [
    ...
    },
    {
        ...
        questions: [
            ...
            { id: 'nonCompeteScope', prompt: 'Non-compete scope:', type: 'text', required: true, helpText: 'Geographic and industry scope' },
...
exports.VALIDATION_CHECKLIST = {
    ...
    contributions: ['hasIP', 'hasCapital', 'hasEquipment'],
    decision_making: ['unanimousDecisions', 'dayToDay', 'deadlockResolution'],
    exit_scenarios: ['voluntaryUnvested', 'voluntaryVested', 'noticePeriod', 'forCauseTerms', 'withoutCauseTerms', 'nonCompeteDuration', 'nonCompeteScope', 'saleAcceleration'],
    custom_terms: [], // All optional
};
function validateSection(sectionId, data) {
    const required = exports.VALIDATION_CHECKLIST[sectionId] || [];
    const missing = required.filter(field => !data[field]);
    return { valid: missing.length === 0, missing };
}
function validateAllSections(data) {
    const missingSections = [];
    for (const [sectionId, fields] of Object.entries(exports.VALIDATION_CHECKLIST)) {
